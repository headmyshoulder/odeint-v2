...
public:
    ...
    void do_step_dxdt( System system , const StateIn &in , const DerivIn &dxdt , value_type t , StateOut &out , value_type dt )
    {
    ...
    void do_step_dxdt( System system , StateInOut &x , const DerivIn &dxdt , value_type t , value_type dt )
    {
