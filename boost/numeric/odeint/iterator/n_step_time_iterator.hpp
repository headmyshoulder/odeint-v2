...
namespace odeint {
        ...
        size_t num_of_steps )
    {
        return std::make_pair(
            n_step_time_iterator< Stepper , System , State >( stepper , system , x , t_start , dt , num_of_steps ) ,
    ...
    /**
     * \fn make_n_step_time_iterator_begin( Stepper stepper , System system , typename Stepper::state_type &x , typename Stepper::time_type t , typename Stepper::time_type dt , size_t num_of_steps )
     *
    ...
    /**
     * \fn make_n_step_time_iterator_end( Stepper stepper , System system , typename Stepper::state_type &x )
    ...
    /**
     * \fn make_n_step_time_range( Stepper stepper , System system , typename Stepper::state_type &x , typename Stepper::time_type t_start , typename Stepper::time_type dt , size_t num_of_steps )
     *
