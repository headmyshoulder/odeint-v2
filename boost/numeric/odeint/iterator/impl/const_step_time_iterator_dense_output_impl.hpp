...
namespace odeint {
    ...
    class const_step_time_iterator< Stepper , System , State , dense_output_stepper_tag > : public detail::ode_time_iterator_base
    <
        const_step_time_iterator< Stepper , System , State , dense_output_stepper_tag > ,
