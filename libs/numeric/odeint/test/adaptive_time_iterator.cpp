...
BOOST_AUTO_TEST_CASE( copy_stepper_iterator )
{
    ...
    state_type x = {{ 1.0 }};
    iterator_type iter1 = iterator_type( dummy_controlled_stepper() , empty_system() , x , 0.0 , 0.999 , 0.1 );
...
{
    typedef adaptive_time_iterator< Stepper , empty_system > stepper_iterator;
